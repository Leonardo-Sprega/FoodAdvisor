...
ActiveRecord::Schema[7.0].define(version: 2023_11_29_162155) do
  create_table "foto_recensiones", force: :cascade do |t|
    t.string "url"
    t.integer "recensione_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["recensione_id"], name: "index_foto_recensiones_on_recensione_id"
  end
  ...
  add_foreign_key "foto_recensiones", "recensiones"
